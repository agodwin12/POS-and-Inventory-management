...
<section id="content">
    ...
    <!-- NAVBAR -->
    <div class="topic">
        <h1 style="text-align: center">Suppliers List</h1>
    </div>
    <div class="nstaff">
        <button type="submit" class="btn btn-success"><a href="addSupliers.php">New</a></button>
    </div>
    <!-- MAIN -->
    <main>
        <table id="example" class="table table-striped" style="width:100%">
            ...
            <tr>
                ...
                <td><img src='images/".$row['picture']."' width='20%'></td>
                 <td>
                  <a class='btn btn-primary' href='adminSupplierUpdate.php?id=$row[id]'>UPDATE</a>
                  <a class='btn btn-danger' href='supplierDelete.php?id=$row[id]' name='delete'>DELETE</a>
