...
<section id="content">
    ...
    <!-- NAVBAR -->
    <div class="topic">
        <h1 style="text-align: center; text-decoration: underline">EMPLOYEE DIRECTORY</h1>
    </div>
    <div class="nstaff">
        <button type="submit" class="btn btn-success"><a href="addStaff.php">NEW STAFF</a></button>
    </div>
    <!-- MAIN -->
    <main>
        ...
        <table id="example" class="table table-striped" style="width:100%">
            ...
            while ($row=$result->fetch_assoc()){
                ...
                <td>$row[id]</td>
                  ...
                  <td>$row[salary]</td>
                  <td><img src='images/".$row['picture']."' width='20%'></td>
                  <td>
                  <a class='btn btn-primary' href='adminStaffUpdate.php?id=$row[id]'>UPDATE</a>
                  <a class='btn btn-danger' href='delete.php?id=$row[id]' name='delete'>DELETE</a>
